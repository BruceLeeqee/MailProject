...
public interface IOrderService {
    ...
    Integer killOrder(@RequestParam("addressId") int addressId, @RequestBody KillGoodsSpecPriceDetailVo killGoods, @RequestParam("userId") String userId);

    @RequestMapping(value = "/killOrder2", method = RequestMethod.POST)
    Integer killOrder(@RequestBody KillOrderVo killOrderVo);
    ...
    Order selectOrderDetail(@RequestParam("orderId") Integer orderId);

    @RequestMapping(value = "/selectMyOrderDetail", method = RequestMethod.POST)
    Order selectMyOrderDetail(@RequestParam("orderId") Integer orderId, @RequestParam("userId") String userId);

    @RequestMapping(value = "/cancel", method = RequestMethod.POST)
    void cancel(@RequestParam("orderId") Integer orderId);

    @RequestMapping(value = "/selfCancel", method = RequestMethod.POST)
    void selfCancel(@RequestParam("orderId") Integer orderId, @RequestParam("userId") String userId);
    ...
    void confirmReceiveGoods(@RequestParam("orderId") Integer orderId, @RequestParam("userId") String userId);
}
